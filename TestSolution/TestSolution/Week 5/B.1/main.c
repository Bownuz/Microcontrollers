...
int main()
{
	...
	spi_writeWord(1, 5);  // Zet cijfer 5 op de eerste positie
	spi_writeWord(2, 8);  // Zet cijfer 8 op de tweede positie
	spi_writeWord(3, 3);  // Zet cijfer 3 op de derde positie
	spi_writeWord(4, 7);  // Zet cijfer 7 op de vierde positie
